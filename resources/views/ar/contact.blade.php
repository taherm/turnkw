	...
	<br>
		<div class="container">
			...
			<div class="row align-items-center">
                ...
                <p>
            <ul>
           <li> هاتف :   ٢٢٩١٣٣٦٧ ٩٦٥+</li>

<li>العنوان:</li>

<li>دولة الكويت – شرق – قطعة ٦ – شارع مبارك الكبير – برج الدروازة ٥١ – الدور ٧

</li>

<li>:البريد الإلكترونيinfo@tasaweeq.com	</li>
</ul>
					</p>
				</div>
...
<div class="container">
	...
	<div class="row align-items-center">
		...
		{{ csrf_field() }}     
            ...
            <div class="form-row">
                <div class="form-group col">
                    <input type="submit" value="إرسال" class="btn btn-primary btn-lg" data-loading-text="Loading...">
                </div>
            </div>
        </form>
		</div>
