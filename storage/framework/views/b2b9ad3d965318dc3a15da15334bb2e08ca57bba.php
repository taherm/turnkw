...
<div class="col-md-12 main">
    <div class="content-top-1">
        <div>
            ...
            <div class="col-md-2">
                <a class="btn btn-success btn-lg" role="button" href="/admin/create-service"> Add Service</a>
            </div>
        </div>
        <div class="space"></div>
        <hr>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="gradeU">
                            ...
                            <td> <a class="btn btn-default" href="<?php echo e(url('admin/service/'.$s->id.'/edit')); ?>">Edit</a> </td>
                            <td>
                                <form method="POST" action="/admin/service/<?php echo e($s->id); ?>" class="delete">
